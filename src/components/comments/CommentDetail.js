...
class CommentDetail extends Component {
  ...
  onClickAction( id, type ){
     ...
     var finishedData  = [];
     finishedData = this.renderData( this.state.comments, [], cookie.get('loginState'));
  ...
  render(){
    ...
    hope = this.renderData( this.state.comments, [], cookie.get('loginState') );
    ...
    return(
      <div className="commentDetail">
          ...
          <TextEditor
              ...
              getNewReply={ this.props.getArticleDetail.bind(this, `http://127.0.0.1:8080/articleDetail/${this.props.articleId}`, this.props.articleId,  cookie.get('userId') )}
          />
      </div>
